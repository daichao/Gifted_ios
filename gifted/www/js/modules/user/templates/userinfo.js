define([],function(){
	...
	result.content = 
			'<div class="content_wrapper">'+
				'<img class="gifted-image userinfo_image userinfo_portrait" src="img/noportrait.png" />' +
				...
				'<div class="useredit_businesscard">' +
					...
					'<img class="gifted-image userinfo_image useredit_businesscard_pic" src="img/notexists_80_80.png" />' +
				...
				'<div class="useredit_businesslicence">' +
					...
					'<img class="gifted-image userinfo_image useredit_businesslicence_pic" src="img/notexists_80_80.png" />' +
