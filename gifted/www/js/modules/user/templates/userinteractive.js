define(['css!lib/owl.carousel/owl.carousel.css', 'css!lib/owl.carousel/owl.theme.css'],function(){
	...
	result.links = 
		'<div class="userinteractive_favorite">' +
			'<a class="userinteractive_favorite_link" data-translate="favorites" data-translate-param="{{this.userInfo.NAME}}"></a>(All)' +
	...
	result.products = 
		...
		'<a href="#product/detail/{{ID}}">' + // imageView/3/w/200/h/150/q/50
			'<img alt="{{PHOTONAME}}" src="{{PHOTOURL}}?imageView2/1/w/200/h/150/q/50" class="userinteractive_other_img product_image_{{PHOTOID}}" />' +
		'</a>' +
		'{{/each}}' +
		'<a>' +
