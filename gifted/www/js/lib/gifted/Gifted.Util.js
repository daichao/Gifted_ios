...
define(['underscore','jquery'],function(_,$){
	...
	(function(){
		...
		FileUploader.prototype.photoDelete=function(options1) {
			try {
				this.check();
				options1=options1||{};
				...
				if (options1 && options1.callback)
					options1.callback(this.imageKey);
			} catch (E) {
				Gifted.Global.alert(E.message);
			}
		};
	...
	//================================== delayedFn ==================================//
	Gifted.Util.DelayedTask = function(fn,interval,scope,repeat,count,args){
		this.count = 0;
