...
$.widget( "mobile.tabs", $.mobile.widget, {
	...
	_create: function(){
		...
		var $content = $tabs.parent().find('div[data-role="tabs-content"]');
		...
		function navButtonClick(event) {
			...
			$this.changeTab(event, {
				...
				nextContent: $content.find('#'+$(this).attr('href'))
			});
	...
	currentContent: function() {
		return this.element.parent().find('div[data-role="tabs-content"]').children().filter('.ui-tabs-content-active');
	},
