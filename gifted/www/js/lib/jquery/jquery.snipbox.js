...
(function($) {
	$.widget( "mobile.spinbox", {
		...
		_create: function() {
			...
			w.d.wrap.addClass("ui-extends-snipbox-group" ); // by zhouxw
			w.d.inputWrap.addClass( "ui-extends-snipbox-inputwrap" ); // by zhouxw
			w.d.input.addClass( "ui-extends-snipbox-input" ); // by zhouxw
			if ( o.type !== "vertical" ) {
				/*w.d.inputWrap.css( { 
